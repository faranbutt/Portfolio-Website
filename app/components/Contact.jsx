...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_7r01wl4','template_glg4gnc',{
      from_name:form.name,
      to_name:"Faran",
      from_email:form.email,
      to_email:"faranbutt789@gmail.com",
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('left','tween',0.2,1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form action="" ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <button type="submit" className="bg-tertiary py-3 px-8 outline-none w-fit text-white rounded-xl font-bold shadow-md shadow-primary">
